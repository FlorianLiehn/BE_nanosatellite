...
class RainSpecificAttenuation :
        ...
        tau=45
        theta=30
        hr=420  #altitude nanosatellite en km
        hs=0.3 #altitude station sol en km
        ...
        def __init__(self,r0_01_rainfall_rate,frequence):
                ...
                self.a0_01_attenuation = self.rain_specific_attenuation*self.longueurEffectivePluie(frequence)[1]
